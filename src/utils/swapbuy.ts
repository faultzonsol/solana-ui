 ...
 */
export const executeSwapBuy = async (
  wallets: WalletSwapBuy[],
  tokenConfig: TokenConfig,
  customAmounts?: number[]
): Promise<{ success: boolean; result?: any; error?: string }> => {
  try {
    console.log(`Preparing to swap buy ${tokenConfig.tokenAddress} using ${wallets.length} wallets`);
...
/**
 * Validate swap buy inputs
 */
export const validateSwapBuyInputs = (
  wallets: WalletSwapBuy[],
  tokenConfig: TokenConfig,
